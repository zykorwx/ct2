...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ComprasEmpresaFavorita'
        db.create_table(u'usuarios_comprasempresafavorita', (
        ...
        db.send_create_signal('usuarios', ['ComprasEmpresaFavorita'])


    def backwards(self, orm):
        # Deleting model 'ComprasEmpresaFavorita'
        db.delete_table(u'usuarios_comprasempresafavorita')
