...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tarjeta.tipo_tarjera'
        db.delete_column(u'usuarios_tarjeta', 'tipo_tarjera')


        # Changing field 'Tarjeta.dni'
        db.alter_column(u'usuarios_tarjeta', 'dni', self.gf('django.db.models.fields.CharField')(max_length=10))
        # Deleting field 'Perfil.tipo_user_tarjera'
        db.delete_column(u'usuarios_perfil', 'tipo_user_tarjera')


    def backwards(self, orm):
        # Adding field 'Tarjeta.tipo_tarjera'
        db.add_column(u'usuarios_tarjeta', 'tipo_tarjera',
                      self.gf('django.db.models.fields.CharField')(default='pr', max_length=2),
                      keep_default=False)


        # Changing field 'Tarjeta.dni'
        db.alter_column(u'usuarios_tarjeta', 'dni', self.gf('django.db.models.fields.CharField')(max_length=20))
        # Adding field 'Perfil.tipo_user_tarjera'
        db.add_column(u'usuarios_perfil', 'tipo_user_tarjera',
                      self.gf('django.db.models.fields.CharField')(default='pr', max_length=2),
                      keep_default=False)
