...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tarjeta'
        db.create_table(u'usuarios_tarjeta', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dni', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('tipo_tarjera', self.gf('django.db.models.fields.CharField')(default='pr', max_length=2)),
            ('estado', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('usuarios', ['Tarjeta'])

        # Adding model 'userTarjeta'
        db.create_table(u'usuarios_usertarjeta', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('tarjeta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['usuarios.Tarjeta'])),
            ('fecha_alta', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('fecha_baja', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('estado', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('usuarios', ['userTarjeta'])
        ...
        db.create_table(u'usuarios_perfil', (
            ...
            ('tipo_user_tarjera', self.gf('django.db.models.fields.CharField')(default='pr', max_length=2)),
        ))
        db.send_create_signal('usuarios', ['Perfil'])


    def backwards(self, orm):
        # Deleting model 'Tarjeta'
        db.delete_table(u'usuarios_tarjeta')

        # Deleting model 'userTarjeta'
        db.delete_table(u'usuarios_usertarjeta')
