...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Perfil.avatar'
        db.delete_column(u'usuarios_perfil', 'avatar')

        # Deleting field 'Perfil.id'
        db.delete_column(u'usuarios_perfil', u'id')

        # Adding field 'Perfil.fecha_nacimiento'
        db.add_column(u'usuarios_perfil', 'fecha_nacimiento',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Perfil.sexo'
        db.add_column(u'usuarios_perfil', 'sexo',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Perfil.ubicacion'
        db.add_column(u'usuarios_perfil', 'ubicacion',
                      self.gf('django.db.models.fields.CharField')(max_length=70, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Perfil.json_facebook'
        db.add_column(u'usuarios_perfil', 'json_facebook',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Perfil.user'
        db.alter_column(u'usuarios_perfil', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True))

    def backwards(self, orm):
        # Adding field 'Perfil.avatar'
        db.add_column(u'usuarios_perfil', 'avatar',
                      self.gf('django.db.models.fields.files.ImageField')(default='asdasd', max_length=100),
                      keep_default=False)

        # Adding field 'Perfil.id'
        db.add_column(u'usuarios_perfil', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)

        # Deleting field 'Perfil.fecha_nacimiento'
        db.delete_column(u'usuarios_perfil', 'fecha_nacimiento')

        # Deleting field 'Perfil.sexo'
        db.delete_column(u'usuarios_perfil', 'sexo')

        # Deleting field 'Perfil.ubicacion'
        db.delete_column(u'usuarios_perfil', 'ubicacion')

        # Deleting field 'Perfil.json_facebook'
        db.delete_column(u'usuarios_perfil', 'json_facebook')


        # Changing field 'Perfil.user'
        db.alter_column(u'usuarios_perfil', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True))
    ...
    models = {
        ...
        'usuarios.comprasempresafavorita': {
            'Meta': {'object_name': 'ComprasEmpresaFavorita'},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ultimaCompra': ('django.db.models.fields.DateField', [], {}),
        ...
        'usuarios.compraspasadas': {
            ...
            'cantidad': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['empresas.Tags']"}),
            'us': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        'usuarios.perfil': {
            'Meta': {'object_name': 'Perfil'},
            'fecha_nacimiento': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            'json_facebook': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'sexo': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'ubicacion': ('django.db.models.fields.CharField', [], {'max_length': '70', 'null': 'True', 'blank': 'True'}),
