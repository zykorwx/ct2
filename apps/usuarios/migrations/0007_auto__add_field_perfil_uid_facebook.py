...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Perfil.uid_facebook'
        db.add_column(u'usuarios_perfil', 'uid_facebook',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Perfil.uid_facebook'
        db.delete_column(u'usuarios_perfil', 'uid_facebook')
    ...
    models = {
        ...
        'usuarios.perfil': {
            ...
            'uid_facebook': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
