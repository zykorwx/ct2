...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ComprasPasadas.tag'
        db.alter_column(u'usuarios_compraspasadas', 'tag_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empresas.Tags']))
        # Adding field 'ComprasEmpresaFavorita.ultimaCompra'
        db.add_column(u'usuarios_comprasempresafavorita', 'ultimaCompra',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 9, 17, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ComprasPasadas.tag'
        db.alter_column(u'usuarios_compraspasadas', 'tag_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['promociones.Tags']))
        # Deleting field 'ComprasEmpresaFavorita.ultimaCompra'
        db.delete_column(u'usuarios_comprasempresafavorita', 'ultimaCompra')
