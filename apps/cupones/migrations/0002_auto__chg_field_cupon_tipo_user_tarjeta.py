...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cupon.tipo_user_tarjeta'
        db.alter_column(u'cupones_cupon', 'tipo_user_tarjeta', self.gf('django.db.models.fields.CharField')(max_length=13))

    def backwards(self, orm):

        # Changing field 'Cupon.tipo_user_tarjeta'
        db.alter_column(u'cupones_cupon', 'tipo_user_tarjeta', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    models = {
        ...
        'cupones.cupon': {
            ...
            'tipo_user_tarjeta': ('django.db.models.fields.CharField', [], {'max_length': '13'}),
