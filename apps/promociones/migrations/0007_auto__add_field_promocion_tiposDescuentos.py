...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Promocion.tiposDescuentos'
        db.add_column(u'promociones_promocion', 'tiposDescuentos',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Promocion.tiposDescuentos'
        db.delete_column(u'promociones_promocion', 'tiposDescuentos')
    ...
    models = {
        ...
        'promociones.promocion': {
            ...
            'tiposDescuentos': ('django.db.models.fields.CharField', [], {'max_length': '80', 'blank': 'True'}),
