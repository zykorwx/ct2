...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'promociones_promocion_categoria', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('promocion', models.ForeignKey(orm['promociones.promocion'], null=False)),
            ('sub_categoria', models.ForeignKey(orm['promociones.sub_categoria'], null=False))
        ))
        db.create_unique(u'promociones_promocion_categoria', ['promocion_id', 'sub_categoria_id'])


    def backwards(self, orm):
        # Removing M2M table for field categoria on 'Promocion'
        db.delete_table('promociones_promocion_categoria')
