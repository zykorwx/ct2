...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'promociones_categoria', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('promociones', ['Categoria'])

        # Adding model 'Sub_categoria'
        db.create_table(u'promociones_sub_categoria', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('Categoria', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['promociones.Categoria'])),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('promociones', ['Sub_categoria'])
        ...
        db.create_table(u'promociones_promocion', (
            ...
            ('titulo_promocion', self.gf('django.db.models.fields.CharField')(max_length=1)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'promociones_categoria')

        # Deleting model 'Sub_categoria'
        db.delete_table(u'promociones_sub_categoria')
