...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tags'
        db.create_table(u'promociones_tags', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(default='none', max_length=30)),
        ))
        db.send_create_signal('promociones', ['Tags'])


    def backwards(self, orm):
        # Deleting model 'Tags'
        db.delete_table(u'promociones_tags')
    ...
    models = {
        ...
        'promociones.promocion': {
            ...
            'categoria': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['promociones.Tags']", 'symmetrical': 'False'}),
