...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Promocion.fecha_publicacion'
        db.alter_column(u'promociones_promocion', 'fecha_publicacion', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Promocion.fecha_termino'
        db.alter_column(u'promociones_promocion', 'fecha_termino', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Promocion.fecha_publicacion'
        db.alter_column(u'promociones_promocion', 'fecha_publicacion', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Promocion.fecha_termino'
        db.alter_column(u'promociones_promocion', 'fecha_termino', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        'promociones.promocion': {
            ...
            'fecha_publicacion': ('django.db.models.fields.DateField', [], {'default': "'2010-01-01'", 'blank': 'True'}),
            'fecha_termino': ('django.db.models.fields.DateField', [], {'default': "'2010-01-01'", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
