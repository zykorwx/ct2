...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comentario_promocion.titulo'
        db.add_column(u'comentarios_comentario_promocion', 'titulo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comentario_promocion.titulo'
        db.delete_column(u'comentarios_comentario_promocion', 'titulo')
