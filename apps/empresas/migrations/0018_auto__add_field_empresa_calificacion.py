...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Empresa.calificacion'
        db.add_column(u'empresas_empresa', 'calificacion',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Empresa.calificacion'
        db.delete_column(u'empresas_empresa', 'calificacion')
