...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Empresa.fecha_alta'
        db.add_column(u'empresas_empresa', 'fecha_alta',
                      self.gf('django.db.models.fields.DateTimeField')(default='2013-07-07 17:27:17', auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Empresa.fecha_alta'
        db.delete_column(u'empresas_empresa', 'fecha_alta')
