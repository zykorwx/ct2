...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Empresa.codigo_confirmacion'
        db.add_column(u'empresas_empresa', 'codigo_confirmacion',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Empresa.codigo_confirmacion'
        db.delete_column(u'empresas_empresa', 'codigo_confirmacion')
    ...
    models = {
        ...
        'empresas.empresa': {
            ...
            'codigo_confirmacion': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
