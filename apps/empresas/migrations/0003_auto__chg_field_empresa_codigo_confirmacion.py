...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Empresa.codigo_confirmacion'
        db.alter_column(u'empresas_empresa', 'codigo_confirmacion', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'Empresa.codigo_confirmacion'
        db.alter_column(u'empresas_empresa', 'codigo_confirmacion', self.gf('django.db.models.fields.CharField')(max_length=30))
