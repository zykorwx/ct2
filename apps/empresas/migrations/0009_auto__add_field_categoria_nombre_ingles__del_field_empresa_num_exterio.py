...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Categoria.nombre_ingles'
        db.add_column(u'empresas_categoria', 'nombre_ingles',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=30),
                      keep_default=False)

        # Deleting field 'Empresa.num_exterior'
        db.delete_column(u'empresas_empresa', 'num_exterior')


    def backwards(self, orm):
        # Deleting field 'Categoria.nombre_ingles'
        db.delete_column(u'empresas_categoria', 'nombre_ingles')

        # Adding field 'Empresa.num_exterior'
        db.add_column(u'empresas_empresa', 'num_exterior',
