...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Empresa.latitud_mapa'
        db.delete_column(u'empresas_empresa', 'latitud_mapa')

        # Deleting field 'Empresa.longitud_mapa'
        db.delete_column(u'empresas_empresa', 'longitud_mapa')

        # Adding field 'Empresa.LatLng'
        db.add_column(u'empresas_empresa', 'LatLng',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Empresa.latitud_mapa'
        db.add_column(u'empresas_empresa', 'latitud_mapa',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Empresa.longitud_mapa'
        db.add_column(u'empresas_empresa', 'longitud_mapa',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Empresa.LatLng'
        db.delete_column(u'empresas_empresa', 'LatLng')
    ...
    models = {
        ...
        'empresas.categoria': {
            ...
            'nombre_ingles': ('django.db.models.fields.CharField', [], {'default': "'none'", 'max_length': '30'})
        },
        'empresas.empresa': {
