...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sub_categoria.Categoria'
        db.delete_column(u'empresas_sub_categoria', 'Categoria_id')


    def backwards(self, orm):
        # Adding field 'Sub_categoria.Categoria'
        db.add_column(u'empresas_sub_categoria', 'Categoria',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['empresas.Categoria']),
                      keep_default=False)
