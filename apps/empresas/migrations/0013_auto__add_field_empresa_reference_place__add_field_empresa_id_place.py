...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Empresa.reference_place'
        db.add_column(u'empresas_empresa', 'reference_place',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=155, blank=True),
                      keep_default=False)

        # Adding field 'Empresa.id_place'
        db.add_column(u'empresas_empresa', 'id_place',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=48, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Empresa.reference_place'
        db.delete_column(u'empresas_empresa', 'reference_place')

        # Deleting field 'Empresa.id_place'
        db.delete_column(u'empresas_empresa', 'id_place')
