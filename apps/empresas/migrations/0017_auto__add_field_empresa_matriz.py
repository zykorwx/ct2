...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Empresa.matriz'
        db.add_column(u'empresas_empresa', 'matriz',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empresas.Empresa'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Empresa.matriz'
        db.delete_column(u'empresas_empresa', 'matriz_id')
