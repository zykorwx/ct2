...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Categoria', fields ['nombre_ingles']
        db.create_unique(u'empresas_categoria', ['nombre_ingles'])


    def backwards(self, orm):
        # Removing unique constraint on 'Categoria', fields ['nombre_ingles']
        db.delete_unique(u'empresas_categoria', ['nombre_ingles'])
