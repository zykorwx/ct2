...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tags'
        db.create_table(u'empresas_tags', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('empresas', ['Tags'])

        # Adding M2M table for field tags on 'Categoria'
        m2m_table_name = db.shorten_name(u'empresas_categoria_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('categoria', models.ForeignKey(orm['empresas.categoria'], null=False)),
            ('tags', models.ForeignKey(orm['empresas.tags'], null=False))
        ))
        db.create_unique(m2m_table_name, ['categoria_id', 'tags_id'])


    def backwards(self, orm):
        # Deleting model 'Tags'
        db.delete_table(u'empresas_tags')

        # Removing M2M table for field tags on 'Categoria'
        db.delete_table(db.shorten_name(u'empresas_categoria_tags'))
